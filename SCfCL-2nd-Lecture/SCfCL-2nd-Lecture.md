...
- `append()`メソッドを使ってリストに新たにリストを付けることができます
...
- リスト型との違いは，一度タプル型をつくると格納されている要素やその順番をいっさい変更することができない
...
1,2 # ()がなくてもタプル型になる
1, # ()がない場合でオブジェクトが1つの場合もカンマをつけることでタプ型になる
```
...
my_dict['tea'] # キーを指定して対応するバリューを表示
