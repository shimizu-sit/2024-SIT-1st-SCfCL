...
paginate: true
---
<!-- スライドURL：https://docs.google.com/presentation/d/12RwxAsR2vb_9gLAxtJWIc6kynMn_hVTy905Z90kvwH8/edit?usp=sharing --->
...
## P.13の内容「Colabで実行するので「￥」ではなく「/(スラッシュ)」で表示されます」

### 訂正
- 環境（特にWindows環境）によっては，「**/(スラッシュ)**」ではなく「**¥(円マーク)**」で表示されます
- どちらの表記もありますので両方とも覚えておいてください
